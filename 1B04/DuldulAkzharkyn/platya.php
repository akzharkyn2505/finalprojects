...
<?php
	...
	$result = mysql_query("SELECT * FROM odejda WHERE id=18 ");
	...
	$result = mysql_query("SELECT * FROM odejda WHERE id=19 ");
	$row = mysql_fetch_array($result);
	...
	$result = mysql_query("SELECT * FROM odejda WHERE id=20 ");
	$row = mysql_fetch_array($result);
	...
	$result = mysql_query("SELECT * FROM odejda WHERE id=21 ");
	$row = mysql_fetch_array($result);
	...
	$result = mysql_query("SELECT * FROM odejda WHERE id=22 ");
	$row = mysql_fetch_array($result);
	...
	$result = mysql_query("SELECT * FROM odejda WHERE id=23 ");
	$row = mysql_fetch_array($result);
